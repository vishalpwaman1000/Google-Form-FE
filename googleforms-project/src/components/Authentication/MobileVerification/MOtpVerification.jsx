...
import "./MOtpVerification.scss";
import { Button, TextField, InputAdornment } from "@material-ui/core";
import ErrorIcon from "@material-ui/icons/Error";

export class MOtpVerification extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="otpVerification_Container">
        <div
          ...
          style={{ width: "442px", height: "550px" }}
        >
          <div
          ...
          >
            ...
            <div className="body">
              <div className="otpVerification_Header">
                <div className="otpVerification_Inner">Enter your OTP</div>
                <div
...
export default MOtpVerification;
